...
public class LoginDataManager{
    ...
    public static String getExpectedSuccessTitle(){ return data.getJSONObject("messages").getString("loginSuccessTitle"); }
    public static String getExpectedErrorMessage(){
        return data.getJSONObject("messages").getString("loginError");
    }
    public static String getExpectedLoginPageHeading () { return data.getString("loginPageHeading"); }
}
